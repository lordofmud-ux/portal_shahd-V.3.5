(function (root, factory) {
  ...
  function drawLine(x1, x2, style, x, y){
    ...
    this.context.beginPath();
    this.context.moveTo(style.direction != 'left' ? x1 : x, y);
    this.context.lineTo(style.direction != 'right' ? x2 : x, y);
    this.context.stroke();
  ...
  Sparkline.prototype.draw = function (points) {
    ...
    dot(this.options.startColor, this.options.staltrine, offsetX + (points.length == 1 ? width / 2 : 0), y(0));
